...
lines = len(values) - 1
width_of_row = len(values[0])


def run(right: int, down: int):
...
totals = list()
totals.append(run(1, 1))
totals.append(run(3, 1))
totals.append(run(5, 1))
totals.append(run(7, 1))
totals.append(run(1, 2))
